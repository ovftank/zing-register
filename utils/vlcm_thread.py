...
class VLCMThread:
    ...
    def click_center(self, selector: str):
        ...
        # validate các giá trị trong box
        x = box.get("x", 0)
        y = box.get("y", 0)
    ...
    def register(self):
        self.page.goto("https://vlcm.zing.vn/", wait_until="domcontentloaded")
        ...
        username = generate_username(self.prefix, skip_usernames=self.skip_usernames)
        password_str = (
        ...
        try:
            with self.page.expect_request(
                lambda req: req.url.startswith("http://360game.vn/auth/login-redirect"),
                timeout=30000,
            ):
